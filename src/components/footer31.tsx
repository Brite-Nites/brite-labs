      ...
      <div className="w-full px-7 md:px-14 lg:px-28">
        ...
        <div className="mt-20 flex flex-col justify-between gap-16 lg:flex-row">
          <div className="flex w-full max-w-md flex-col gap-10">
            <div className={cn("space-y-1 text-sm font-light tracking-tight lg:text-base", textMuted)}>
              ...
              {state.status === "success" ? (
                <div className={cn("mt-10 flex items-center gap-2", isDark ? "text-primary" : "text-green-600")}>
                  <Check className="size-4" />
                  <span>{state.message}</span>
                </div>
              ) : (
                <form action={formAction} className={cn("flex w-full items-end border-b", borderColor)}>
                  <Input
                    type="email"
                    name="email"
                    placeholder="Email*"
                  ...
                  />
                  <Button type="submit" variant="ghost" disabled={isPending} className={textColor}>
                    <ArrowRight />
                  </Button>
                </form>
              )}
          ...
          <div className={cn("grid w-full max-w-xs grid-cols-2 gap-10 text-sm font-light lg:text-base", textMuted)}>
            {/* TODO: Replace with real address (BRI-2014) */}
            <div className="w-32">Salt Lake City, UT</div>
            <ul className="space-y-1">
